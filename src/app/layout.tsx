...
export const metadata = {
  ...
  description:
    ...
    openGraph: {
      title: "Forest Meet",
      description: "Virtual gatherings with friends around a cozy virtual campfire.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${googlePixelifySans.className} scroll-smooth bg-[url('/bg_light.gif')] bg-cover bg-fixed text-xl text-black duration-300 selection:bg-green-800 selection:text-white dark:bg-[url('/bg_dark.gif')] dark:text-neutral-200`}
      >
        <AppSessionProvider>
