    ...
    <main className="flex h-screen w-full items-center justify-center">
      <Box className="mt-[80px] grid animate-fade grid-cols-1 grid-rows-2 gap-5 p-10">
        ...
        <div className="flex flex-col space-y-3 justify-center">
          <span className=" tablet:text-2xl laptop:text-3xl text-justify">
		  ...
		  <div className="flex space-x-5 justify-center items-center">
		     <NextLink href={Routes.information}>Contact <MonkeyIcon width={40} height={40}/></NextLink>
			<NextLink href={Routes.support}>Support <CoffeeIcon width={40} height={40}/></NextLink>
		  </div>
        </div>
      </Box>
    </main>
