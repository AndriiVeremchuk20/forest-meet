    ...
    <main className="w-full items-center">
      <div className="flex flex-col items-center space-y-5 py-[120px]">
        <Box className="flex flex-col items-center p-10">
          ...
          <ul className="list-inside list-image-[url(/icon/marchmellow.svg)] space-y-2 text-2xl">
            <li>
              Profile page: Manage your data including name, avatars, and meet
              records.
            </li>
            <li>
              Authorization with email and password, as well as other services
        ...
        <Box className="flex flex-col items-center space-y-5 p-10">
          <h2 className="border-b-4 border-black text-5xl dark:border-white">
            Contact
          </h2>
          <div className="flex flex-col items-center justify-center text-3xl">
            <span>If you want to say something, write to: </span>
            <a
              href="mailto:forestmeet2@gmail.com"
              className="text-rose-600 hover:text-rose-700"
            >
              forestmeet2@gmail.com
            </a>
          </div>
        </Box>
      </div>
